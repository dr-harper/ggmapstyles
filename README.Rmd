...
```{r, fig.height=7.5, fig.width=7.5, echo = FALSE, message = FALSE, warning = FALSE}
...
urls <- c("https://snazzymaps.com/style/35/avocado-world",
          ...
          "https://snazzymaps.com/style/60952")
...
ggmap(get_snazzymap(center = "Southampton, UK", mapRef = x, maptype = "roadmap")) +
  theme_void() +
  annotate(geom = "label", x = -1.404351, y = 50.9097, label = paste0(basename(dirname(x)), "/\n", basename(x)), alpha = 0.75) +
